...
| PLUGIN-001 | in_progress | root/user | Run the first-party OpenWear desktop-local proof | Desktop host restart | Project-scoped STDIO server and synthetic read proof validate; restart host, confirm `/mcp`, and approve only `get_data_coverage` |
